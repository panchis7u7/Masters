...
La evaluación se realizará de forma directa con cada base de datos vectorial: consulta semántica, recuperación de documentos y cálculo de métricas sobre el ranking devuelto.
